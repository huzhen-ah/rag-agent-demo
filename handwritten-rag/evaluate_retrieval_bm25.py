...
if __name__ == "__main__":
    ...
    rag_dataset_path = r"dataset/data.pkl"
    with open(rag_dataset_path,"rb") as f:
        rag_dataset = pickle.load(f)
    chunks = rag_dataset["chunks"]
    bm25_config_path = r"bm25/bm25_config.pkl"
    rag_tool = BM25Retrieval(chunks,bm25_config_path)
    ...
    with open(r"dataset/retrieval_eval.jsonl","r",encoding="utf8") as f:
        for line in f:
            ...
            top_k_chunks = rag_tool.search_documents(question,k)
